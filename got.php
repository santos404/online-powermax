...
<div id="sidebar">
	<ul>
		...
		<li><a href="#clothing"><table><tr><td><img src="res/icons/souvenir.png" /></td>
...
<div id="navbar">
	<ul>
		<li><a class="active" href="got.php">HP laptops</a></li>
		<li><a href="hp.php">Apple laptops</a></li>
		<li><a href="hg.php">DELL LAPTOPS</a></li>		
	</ul>
</div>
...
$products_item .= <<<EOT
	...
	<p align="center" style="font-size: 1.2em;">{$obj->price} </p>
...
<footer class="container">
	<div class="row">	
		<p class="col-sm-6">
			&copy; 2023 POWERMAX | Made with<i style="color: #fd4b4b;">&nbsp; &#9829; &nbsp;</i>in KENYA
		</p>
